namespace HouseHoldApp
{
    partial class WashingForm
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(WashingForm));
            panel_1 = new Panel();
            label4 = new Label();
            txtCost = new TextBox();
            panel2 = new Panel();
            ...
            label9.Location = new Point(19, 72);
            label9.Name = "label9";
            label9.Size = new Size(117, 20);
            label9.TabIndex = 6;
            label9.Text = "Under 3kg: 30$";
            ...
            label5.Location = new Point(176, 187);
            label5.Name = "label5";
            ...
            comboBoxNumDish.Location = new Point(19, 184);
            comboBoxNumDish.Name = "comboBoxNumDish";
            comboBoxNumDish.Size = new Size(151, 28);
            comboBoxNumDish.TabIndex = 4;
            comboBoxNumDish.Text = "0";
            comboBoxNumDish.SelectedIndexChanged += comboBoxNumDish_SelectedIndexChanged;
            // 
            // button1
            // 
            ...
            label6.Location = new Point(46, 15);
            label6.Name = "label6";
            label6.Size = new Size(152, 25);
            label6.TabIndex = 0;
            label6.Text = "Washing Service";
            ...
            BackColor = Color.FromArgb(234, 250, 254);
